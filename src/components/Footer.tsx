      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <Link to="/" className="flex items-center gap-2 mb-4">
              <span className="text-2xl font-bold font-poppins text-tata-dark dark:text-white">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-600 dark:text-gray-300 hover:text-tata-orange transition-colors">Blog</a></li>
              <li><a href="#" className="text-gray-600 dark:text-gray-300 hover:text-tata-orange transition-colors">Documentation</a></li>
              <li><a href="#" className="text-gray-600 dark:text-gray-300 hover:text-tata-orange transition-colors">Help Center</a></li>
              <li><a href="#" className="text-gray-600 dark:text-gray-300 hover:text-tata-orange transition-colors">Community</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex">
              <input type="email" placeholder="Your email" className="px-4 py-2 flex-1 rounded-l-md border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:outline-none focus:border-tata-orange" />
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-4">
            <a href="#" className="text-gray-500 dark:text-gray-400 hover:text-tata-orange text-sm transition-colors">Privacy Policy</a>
            <a href="#" className="text-gray-500 dark:text-gray-400 hover:text-tata-orange text-sm transition-colors">Terms of Service</a>
            <a href="#" className="text-gray-500 dark:text-gray-400 hover:text-tata-orange text-sm transition-colors">Cookie Policy</a>
          </div>
        </div>
      </div>
    </footer>

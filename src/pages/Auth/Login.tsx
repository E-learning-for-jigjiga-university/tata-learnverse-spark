...
const Login = () => {
  ...
  useEffect(() => {
    document.title = 'Login | TaTa LearnVerse';
  }, []);
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-6">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <Link to="/forgot-password" className="text-sm text-tata-orange hover:text-tata-orange/80 transition-colors" target="_blank" rel="noopener noreferrer">
                    Forgot Password?
                  </Link>
                </div>
                <input
              ...
              <div className="flex items-center mb-6">
                <input
                  ...
                  onChange={handleChange}
                  className="h-4 w-4 text-tata-orange border-gray-300 rounded"
                />
              ...
              <p className="text-center text-gray-600">
                ...
                <Link to="/signup" className="text-tata-orange ml-1 hover:text-tata-orange/80 transition-colors" target="_blank" rel="noopener noreferrer">
                  Sign Up
                </Link>
              </p>
            </form>

  ...
  return <div className="min-h-screen flex flex-col">
      ...
      <section className="pt-32 pb-20 bg-tata-soft-gray">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="font-poppins font-bold text-4xl md:text-5xl lg:text-6xl mb-6 text-zinc-950">
              ...
              <Link to="/courses" className="btn btn-primary btn-lg" target="_blank" rel="noopener noreferrer">
                Explore Our Courses
              </Link>
            </div>
            ...
            <div className="relative">
              ...
              <img src="https://images.unsplash.com/photo-1605810230434-7631ac76ec81?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" alt="TaTa Team" className="rounded-xl shadow-lg relative z-10 w-full h-auto" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-tata-light-blue">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <img src="https://images.unsplash.com/photo-1531297484001-80022131f5a1?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1169&q=80" alt="Our Story" className="rounded-xl shadow-lg w-full h-auto" />
            </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => <div key={index} className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-all duration-300">
      ...
      <section className="py-20 bg-tata-soft-gray">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {teamMembers.map((member, index) => <div key={index} className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-300">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="bg-gradient-to-r from-tata-orange to-tata-orange/80 rounded-xl p-8 md:p-12 text-white text-center">
            ...
            <Link to="/signup" className="btn bg-white hover:bg-gray-100 text-tata-orange btn-lg" target="_blank" rel="noopener noreferrer">
              Get Started Today
            </Link>
          </div>
        </div>
